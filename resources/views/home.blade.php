    ...
    <div class="container bg-light p-5" style="border-radius: 20px;">
        <div class="row my-5">
            <div class="col-md-6 d-flex align-items-center">
                <div>
                    <h2>Selamat Datang di Fans Page <br><b>Liverpool Indonesia</b></h2>
                    <h2><b>Youlls Never Walk Alone</b></h2>
                    <p class="text-secondary">Tempat berkumpulnya Anfield Gank Indonesia, <br>Jangan ngaku ANfield Gank kalo belum jadi Member</p>
